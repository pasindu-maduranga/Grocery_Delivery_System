    ...
    <header className="border-b border-gray-100 py-4 px-6 sticky top-0 bg-white z-40 shadow-sm">
      <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link to="/profile" className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold overflow-hidden border-2 border-emerald-200 hover:border-emerald-500 transition-colors">
